...
public class FolderBarLogic : BaseNetLogic
{
	...
	private void InitializeLinuxRootFolder()
	{
        ...
        Log.Info(linuxRootBrowseName);
        Log.Info(linuxRootResourceUri);
	...
	private void InitializeUSBDevices()
	{
		...
		//LogicObject.GetVariable("Model/UsbDetect").Value = connectedUsbDevices;
	...
	private void AddLocations()
	{
        ...
        var systemDrives = locations;
		foreach (var location in systemDrives)
		{
			Log.Info(location.LocationVariableBrowseName);
	...
	{
		var locationVariable = InformationModel.MakeVariable(location.LocationVariableBrowseName, DataTypes.ResourceUri);
